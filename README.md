...
SubAlgoritmo menu3
	...
	Escribir "|                                             |"
	Escribir "|   13. Años de antiguedad                    |"
	Escribir "|                                             |"
...
SubAlgoritmo menu5
	...
	Escribir " _____________________________________________"
	Escribir "| Elija que tipo de ejercicio quiere realizar |"
	Escribir "|   21. Compañia de viajes                    |"
	Escribir "|                                             |"
...
SubAlgoritmo Anio_Bisiesto
	...
	Anio=0
	Escribir " "
	Escribir "Ingrese un año para comprobar si es bisiesto"
	Leer Anio
	si Anio mod 4 =0
		si Anio mod 100=0 
			si Anio mod 400=0
...
SubAlgoritmo Bono_Antiguedad
	...
	si Antiguedad>5
		Salario=Salario+(Salario*0.05)
		Escribir "El salario es de ",Salario,"$ por tener ",Antiguedad," años de antiguedad"
	SiNo
...
SubAlgoritmo Asociacion_Vinicultores
	...
	Escribir " "
	Escribir "Ingrese el tipo y tamaño para determinar el precio"
	Escribir "Tipo:"
	Leer Tipo
	Escribir "Tamaño:"
	Leer Tamanio
...
SubAlgoritmo Vocal
    ...
    SiNo
        si Caracter_Ingresado >= '0' y Caracter_Ingresado <= '9' entonces
            Escribir "El caracter ",Caracter_Ingresado," es un dígito"
        SiNo
            si Caracter_Ingresado = '.' o Caracter_Ingresado = ',' o Caracter_Ingresado = ';' o Caracter_Ingresado = ':' entonces
                Escribir "El caracter ",Caracter_Ingresado," es un símbolo"
            SiNo
                si Caracter_Ingresado = ' ' entonces
                    Escribir "Es un espacio"
                SiNo
                    Escribir "El caracter ",Caracter_Ingresado," no es una vocal, dígito o símbolo"
                FinSi
            FinSi
        FinSi
    FinSi
